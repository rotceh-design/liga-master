...
// Sistema de identidad visual por categoría
const categories = [
  {
    id: 'super-senior',
    name: 'Super Senior',
    ...
    teamList: SS_TEAMS,
    theme: {
      hex: '#F97316', // Bronce / Naranja
      borderHover: 'hover:border-[#F97316]',
      topLineHover: 'group-hover:bg-[#F97316]',
      badgeHover: 'group-hover:bg-[#F97316] group-hover:text-black',
      btnHover: 'hover:bg-[#F97316] hover:text-black',
      text: 'text-[#F97316]'
    }
  },
  {
    ...
    theme: {
      ...
      topLineHover: 'group-hover:bg-[#FFD700]',
      badgeHover: 'group-hover:bg-[#FFD700] group-hover:text-black',
      btnHover: 'hover:bg-[#FFD700] hover:text-black',
      text: 'text-[#FFD700]'
    }
  },
  {
    ...
    theme: {
      hex: '#00F0FF', // Cyan Neón
      borderHover: 'hover:border-[#00F0FF]',
      topLineHover: 'group-hover:bg-[#00F0FF]',
      badgeHover: 'group-hover:bg-[#00F0FF] group-hover:text-black',
      btnHover: 'hover:bg-[#00F0FF] hover:text-black',
      text: 'text-[#00F0FF]'
    }
  },
];
...
const tickerItems = [
  'PATRIOTAS 2 - 1 RIVALS · 2DO CUARTO (08:45)',
...
// Próximos partidos con colores asignados según su categoría
const nextMatches = [
  { day: 'Sáb 15 Mar', time: '14:00', teamA: 'Cóndores', teamB: 'Halcones', cat: 'Dorado', catColor: '#FFD700', stadium: 'Estadio Olímpico' },
  { day: 'Sáb 15 Mar', time: '16:30', teamA: 'Reyes', teamB: 'Guerreros', cat: 'Diamante', catColor: '#00F0FF', stadium: 'Estadio Nacional' },
  { day: 'Dom 16 Mar', time: '11:00', teamA: 'Titanes', teamB: 'Bravos', cat: 'Super Senior', catColor: '#F97316', stadium: 'Estadio Central' },
];
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 text-black font-sans selection:bg-red-500 selection:text-white relative">
            ...
            <div key={i} className="flex items-center shrink-0">
              {tickerItems.map((item, j) => (
                <React.Fragment key={j}>
                  <span className="text-red-500 px-6 font-black text-sm">▸</span>
      ...
      <section className="bg-black relative overflow-hidden px-6 py-16 md:py-24 border-b border-zinc-800 animate-fade-in">
        ...
        <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="inline-flex items-center gap-2 bg-red-600 text-white px-4 py-1.5 mb-8 font-black text-[10px] tracking-widest uppercase">
            ...
            <h1 className="font-black text-6xl md:text-8xl lg:text-[100px] tracking-tighter uppercase text-white leading-[0.9] mb-8">
              La liga<br />
              que nos<br />
              <span className="text-red-500">reúne.</span>
            </h1>
            <p className="font-medium text-sm md:text-base text-zinc-400 max-w-md mb-10 leading-relaxed tracking-wide">
              Resultados en vivo, alineaciones y estadísticas de la Liga Pro — para los que el deporte es más que un simple juego de fin de semana.
            </p>
            <div className="flex flex-wrap gap-4">
              <Link to="/calendario" className="px-8 py-4 bg-red-600 text-white font-black text-sm uppercase tracking-widest hover:bg-red-700 transition-colors">
                Ver Calendario →
              </Link>
          ...
          <div className="relative group">
            ...
            <Link to="/en-vivo" className="block bg-zinc-950 border border-zinc-800 hover:border-zinc-500 transition-all p-8 md:p-10 relative">
              ...
              <div className="flex justify-between items-center mb-8 pl-4">
                ...
                <div className="font-mono font-black text-lg bg-black text-red-500 border border-zinc-800 px-3 py-1 tracking-widest">
                  {featuredMatch.time}
                </div>
              </div>
              ...
              <div className="flex items-center justify-between pl-4">
                ...
                <div className="flex items-center justify-center gap-4 w-1/3">
                  <span className="font-black text-4xl md:text-6xl text-[#FFD700] tabular-nums tracking-tighter">{featuredMatch.scoreA}</span>
              ...
              <div className="mt-8 pt-6 border-t border-zinc-900 flex justify-between items-center text-zinc-500 group-hover:text-white transition-colors">
                ...
                <span className="font-black text-[10px] tracking-widest uppercase text-red-500">Juegos en vivo →</span>
              </div>
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 divide-x divide-y md:divide-y-0 divide-zinc-800">
          {quickStats.map((s, i) => (
            <div key={i} className="p-8 md:p-12 text-center group hover:bg-zinc-900 transition-colors relative overflow-hidden">
              <div className="absolute bottom-0 left-0 w-full h-1 bg-red-500 transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left" />
              <div className="font-black text-4xl md:text-5xl tracking-tighter text-red-500 mb-2">{s.num}</div>
      ...
      {/* ══════════════════════════════════════════════════════════════
          CATEGORÍAS (Colores independientes)
      ══════════════════════════════════════════════════════════════ */}
      <section className="max-w-7xl mx-auto px-6 py-20 md:py-28">
        
        <div className="flex flex-col md:flex-row md:items-end gap-6 mb-12">
          <div className="font-bold text-[10px] tracking-widest uppercase text-white bg-red-600 inline-block px-3 py-1">
            Liga Pro 2026
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {categories.map((cat) => (
            <div 
              key={cat.id} 
              className={`bg-zinc-900 border border-zinc-800 flex flex-col transition-all relative overflow-hidden group ${cat.theme.borderHover}`}
            >
              
              {/* Línea superior con color específico */}
              <div className={`absolute top-0 left-0 w-full h-1 bg-zinc-700 transition-colors ${cat.theme.topLineHover}`} />

              <div className="p-8 flex-1">
                {/* Etiqueta de Categoría interactiva */}
                <div className={`font-bold text-[9px] tracking-widest uppercase bg-zinc-800 text-zinc-400 inline-block px-3 py-1 mb-6 transition-colors ${cat.theme.badgeHover}`}>
                  {cat.name}
                </div>
                
                {/* Número de fondo tintado con el color de la categoría */}
                <div className={`font-black text-8xl absolute -bottom-6 -right-2 pointer-events-none opacity-5 transition-colors ${cat.theme.text}`}>
                  {cat.num}
                </div>

                <h3 className={`font-black text-2xl uppercase tracking-tighter mb-4 transition-colors group-hover:text-white ${cat.theme.text}`}>{cat.name}</h3>
              ...
              {/* Botones de Acción con Hover de su respectivo color */}
              <div className="flex border-t border-zinc-800 bg-zinc-950 mt-auto">
                ...
                <button 
                  ...
                  className={`flex-1 py-4 text-center font-bold text-[10px] tracking-widest uppercase text-zinc-400 transition-colors ${cat.theme.btnHover}`}
                >
                  Ver Franquicias →
                </button>
              </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        ...
        <div className="flex flex-col border border-zinc-200 bg-white shadow-sm">
          {nextMatches.map((g, i) => (
            <Link to="/calendario" key={i} className="flex flex-col md:flex-row md:items-center p-6 border-b border-zinc-100 last:border-0 hover:bg-zinc-50 transition-colors group relative overflow-hidden">
              ...
              <div style={{ backgroundColor: g.catColor }} className="absolute left-0 top-0 w-1 h-full transform scale-y-0 group-hover:scale-y-100 transition-transform origin-bottom" />
              ...
              <div className="flex items-center justify-between md:justify-end gap-6 w-full md:w-auto">
                <div 
                  style={{ color: g.catColor, borderColor: `${g.catColor}40`, backgroundColor: `${g.catColor}10` }} 
                  className="font-black text-[9px] uppercase tracking-widest border px-3 py-1"
                >
                  {g.cat}
                </div>
      ...
      {/* ══════════════════════════════════════════════════════════════
          BOTTOM CTA
      ══════════════════════════════════════════════════════════════ */}
      <section className="bg-black text-white py-20 px-6 border-t-4 border-red-500 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
          <div>
            <div className="font-bold text-[10px] uppercase tracking-widest text-red-500 mb-3">
              ¿Listo para el pitazo inicial?
            </div>
            <h2 className="font-black text-4xl md:text-5xl uppercase tracking-tighter leading-none mb-2">
              Sigue la fecha.
            </h2>
            <h2 className="font-black text-4xl md:text-5xl uppercase tracking-tighter leading-none text-red-500">
              En tiempo real.
            </h2>
          </div>
          <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
            <Link to="/en-vivo" className="px-8 py-4 bg-red-600 text-white font-black text-xs uppercase tracking-widest hover:bg-red-700 transition-colors text-center">
              Juegos en vivo
            </Link>
      ...
      {modalCategory && (
        <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4 md:p-6 animate-fade-in backdrop-blur-sm" onClick={(e) => e.target === e.currentTarget && setModalCategory(null)}>
          <div className="bg-white w-full max-w-4xl max-h-[90vh] flex flex-col shadow-2xl animate-slide-up border border-zinc-300">
            ...
            <div style={{ borderBottomColor: modalCategory.theme.hex }} className="p-6 md:p-8 bg-black text-white flex justify-between items-start shrink-0 border-b-4">
              <div>
                <div className="font-bold text-[10px] tracking-widest uppercase text-zinc-400 mb-2">Directorio de Franquicias</div>
                <h2 style={{ color: modalCategory.theme.hex }} className="font-black text-3xl md:text-4xl uppercase tracking-tighter leading-none">Categoría {modalCategory.name}</h2>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {modalCategory.teamList.map((team, idx) => (
                  ...
                  >
                    ...
                    <div 
                      style={{ '--hover-bg': modalCategory.theme.hex, '--hover-text': modalCategory.slug === 'dorado' || modalCategory.slug === 'diamante' ? '#000' : '#FFF' }}
                      className="w-12 h-12 bg-black text-white rounded-full flex items-center justify-center font-black text-xl shrink-0 transition-colors hover-bg-dynamic"
                    >
                      <style>{`.hover-bg-dynamic:hover { background-color: var(--hover-bg) !important; color: var(--hover-text) !important; }`}</style>
                      {team.initial}
                    </div>
